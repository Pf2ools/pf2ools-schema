...
>;
export declare const homebrewSources: z.ZodArray<
	z.ZodObject<
		{
			path: z.ZodString;
			released: z.ZodString;
	...
	"many"
>;
export declare const homebrewSourcesRecord: z.ZodEffects<
	z.ZodRecord<
		...
		z.ZodObject<
			{
				...
				datatypes: z.ZodArray<
					z.ZodUnion<
						[
							z.ZodEnum<
								["background", "condition", "divineIntercession", "domain", "event", "relicGift", "skill"]
							>,
							z.ZodEnum<["license", "source", "sourceGroup"]>,
						]
					>,
