...
export const homebrewSourceSummary = z.object({
    ...
    publisherAuthors: z
        ...
        .min(1),
    released: date.describe("The homebrew source's publication date (YYYY-MM-DD). For content with a staggered release or early-access program, use the date the source was first made publicly available."),
    added: date.describe("The date (YYYY-MM-DD) the homebrew source was first made available on the Pf2ools ecosystem (complete or otherwise)."),
    modified: date.describe("The date (YYYY-MM-DD) the homebrew source's content-data as maintained by the Pf2ools project was last modified."),
    tags: sourceTags,
...
export const homebrewSources = z
    ...
    .describe("An object mapping IDs as keys to an object containing some summary data about the homebrew source assigned that ID. This is primarily used by `pf2ools-app`.");
