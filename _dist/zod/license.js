...
export const license = z
    ...
    ID: ID.describe("The license's identifying string for the computer. This must be only composed of alphanumeric characters and non-initial, non-terminal hyphens. It must be globally and case-insensitively unique across the Pf2ools ecosystem."),
    title: z
        .object({
        full: z
            .string()
    ...
    data: z
        .object({
        entries: entries.describe("The full text of the license. Formatting may be used where it doesn't detract from its interpretation."),
    })
        .strict(),
