...
export const dataSummary = z
	.object({
		...
		official: z
			...
			.nullable()
			.describe(
				"Whether the source is official (i.e. Paizo-made) or not. `null` is used for non-`source` datatypes.",
			),
	})
...
export const IDs = z
	...
	.describe(
		"An object mapping IDs as keys to an object containing some basic information about the data assigned that ID.",
	);
