                ...
                target: z
                  .object({
                    ...
                    name: z
                      ...
                      .min(1)
                      .describe(
                        "The `name` of the target object, if it is found in an array.",
                      )
                      .optional(),
                  })
                  .strict(),
        ...
        group: z
          .object({
            ...
            "Death and Dying": z
              .literal(true)
              .describe(
                "The condition is in the 'Death and Dying' group (CRB p619).",
              )
              .optional(),
            "Degrees of Detection": z
              .literal(true)
              .describe(
                "The condition is in the 'Degrees of Detection' group (CRB p619).",
              )
              .optional(),
            "Lowered Abilities": z
              .literal(true)
              .describe(
                "The condition is in the 'Lowered Abilities' group (CRB p619).",
              )
              .optional(),
            Senses: z
              .literal(true)
