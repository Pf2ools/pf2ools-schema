    ...
    data: z
      .object({
        ...
        authors: z
          ...
          .min(1)
          .describe(
            "A list of unique authors as credited by the source itself.",
          )
          .optional(),
        publisher: z
          .string()
        ...
        converters: z
          ...
          .min(1)
          .describe(
            "A list of unique Pf2ools contributors who converted this source. If multiple converters exist, choose one 'principal' to go first in the case of questions or bug reports. This is particularly used for homebrew, both to attribute work done and to help organise updates.",
          )
          .optional(),
      })
      .strict(),
